...
static const char *DISPLAY = "waveshare_display";
...
{
    ESP_LOGI(DISPLAY, "Install RGB LCD panel driver"); // Log the start of the RGB LCD panel driver installation
    ...
    ESP_LOGI(DISPLAY, "Initialize RGB LCD panel"); // Log the initialization of the RGB LCD panel
...
#if CONFIG_EXAMPLE_LCD_TOUCH_CONTROLLER_GT911
    ESP_LOGI(DISPLAY, "Initialize I2C bus"); // Log the initialization of the I2C bus
    i2c_master_init(); // Initialize the I2C master
    ESP_LOGI(DISPLAY, "Initialize GPIO"); // Log GPIO initialization
    gpio_init(); // Initialize GPIO pins
    ESP_LOGI(DISPLAY, "Initialize Touch LCD"); // Log touch LCD initialization
    ...
    ESP_LOGI(DISPLAY, "Initialize I2C panel IO"); // Log I2C panel I/O initialization
    ...
    ESP_LOGI(DISPLAY, "Initialize touch controller GT911"); // Log touch controller initialization
